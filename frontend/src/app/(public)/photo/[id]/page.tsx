...
export default function PhotoDetailPage() {
  ...
  return (
    <div className="flex-1 max-w-xl mx-auto bg-gray-100 text-gray-700 flex flex-col">
      <main className="pb-16">
        <div className="p-4">
          {/* 画像表示 */}
          <div className="w-full mb-4 flex justify-center bg-white rounded shadow p-4">
            <Image
              src={photo.imageUrl}
